...
BOOL InitDP()
{
  ...
  CoCreateInstance(CLSID_DirectPlay8Client, NULL, CLSCTX_INPROC, IID_IDirectPlay8Client, (void**)&g_pDPClient);
...
BOOL StartSession(GUID *guidAdapter, char *szIP)
{
  ...
  CoCreateInstance(CLSID_DirectPlay8Address, NULL, CLSCTX_INPROC, IID_IDirectPlay8Address, (void**)&pDPHostAddress);
  CoCreateInstance(CLSID_DirectPlay8Address, NULL, CLSCTX_INPROC, IID_IDirectPlay8Address, (void**)&pDPDeviceAddress);
